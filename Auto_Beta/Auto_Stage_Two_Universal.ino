...
void Auto_Stage_Two_Universal(){
  ...
  Motor motor1 = mirror?right_motor:left_motor, motor2 = mirror?left_motor:right_motor;
  ...
  { 
    Query_Launchpad();
    if(R2.High()&&encoder_motor2>2000){
 ...
 //Continue to pickup bud two and three
  ...
  Parameters_Reset();
  motor2.Control(BCK,60);
  while(encoder_right<6000)  
  { 
    Query_Launchpad();
    if(R2.High()&&encoder_right>2000){
