...
#define TURRET_ANG2MF 3500
#define TURRET_ANG3MF 4350
#define TURRET_ANG4MF 6600
#define TURRET_ANG5MF 10330

#define TURRET_ANG1F 950
#define TURRET_ANG2F 3400
#define TURRET_ANG3F 4000
...
#define Switch_To_Sharp_1() {\
  digitalWrite(SHARP_TOGGLE_PIN, Check_Mirror(LOW, HIGH));\
}

#define Switch_To_Sharp_2() {\
  digitalWrite(SHARP_TOGGLE_PIN, Check_Mirror(HIGH, LOW));\
}
...
int SHARP_SENSOR_PIN, SHARP_SENSOR_PIN_2;// Core phase variables
...
/* if(omit_leaf3 && omit_bud1){
  ...
  SHARP_SENSOR_PIN_2 = Check_Mirror(SHARPL_SENSOR_PIN, SHARPR_SENSOR_PIN);
